...
export class FileService {
    ...
    getFiles() {
        return this.httpClient.get(BASE_URL+'/files').pipe(catchError(this.handleError));
    } 
    ...
    createFolder(fileElement: FileElement) {
        return this.httpClient.post<FileElement>(BASE_URL+'/files', { fileElement: fileElement }, HTTP_OPTIONS)
    ...
    updateFiles(elements: FileElement[], update: Partial<FileElement>, moveTo: any = null) {
        ...
        return this.httpClient.patch<FileElement>(BASE_URL+'/files', { 
            files: files, 
            moveTo: moveTo 
    ...
    deleteFiles(elements: FileElement[]) {
        const req = new HttpRequest('DELETE', BASE_URL+'/files', elements, {
            reportProgress: true
        });
